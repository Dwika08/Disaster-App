...
const List_Data = () => {
  ...
  const getData = () => {
    fetch('http://192.168.18.18/aplikasiV2/restapi.php?op=getMarker21')
      ...
      dataMarker?.map((item, key) => (
        <Marker
          ...
          {/* {item.bencana === 'Tanah Longsor' ? (
            <Image source={require('../../../img/hill.png')} size={32} />
          ) : null}
          {item.bencana === 'Banjir' ? (
            <Image source={require('../../../img/water.png')} size={32} />
          ) : null}
          {item.bencana === 'Kebakaran' ? (
            <Image source={require('../../../img/fire.png')} size={32} />
          ) : null}
          {item.bencana === 'Angin Kencang' ? (
            <Image source={require('../../../img/tornado.png')} size={32} />
          ) : null} */}
          <Callout>
